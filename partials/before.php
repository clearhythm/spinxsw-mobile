...
<html>
  <head>
	  ...
	  <!-- Sets initial viewport load, disables zooming, makes prototype chrome-less once bookmarked to home screen -->
	  <meta name="viewport" content="initial-scale=1, maximum-scale=1, user-scalable=no">
	  <meta name="apple-mobile-web-app-capable" content="yes">
	  <meta name="apple-mobile-web-app-status-bar-style" content="black">

	  <!-- Set a shorter title for iOS6 devices when saved to home screen -->
	  <meta name="apple-mobile-web-app-title" content="SpinXSW">

	  <!-- TODO: Get this working Style the URL status bar -->
		<!-- <meta name="apple-mobile-web-app-status-bar-style" content="black"> -->
